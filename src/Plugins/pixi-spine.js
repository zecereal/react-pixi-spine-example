...
(function (pixi_spine) {
  ...
  (function (core) {
    var Ticker = (function () {
      /*
      //EDIT: Uncomment this for using separate ticker instance.
    ...
    var AnimationState = (function () {
        ...
        for (var i_16 = 0, n_1 = tracks.length; i_16 < n_1; i_16++) {
          ...
          if ((i_16 == 0 && mix == 1) || blend == core.MixBlend.add) {
            for (var ii = 0; ii < timelineCount; ii++) {
              ...
              if (timeline instanceof core.AttachmentTimeline) this.applyAttachmentTimeline(timeline, skeleton, animationTime, blend, true);
      ...
      AnimationState.prototype.applyMixingFrom = function (to, skeleton, blend) {
        ...
        if (blend == core.MixBlend.add) {
          ...
          for (var i = 0; i < timelineCount; i++) {
            ...
            if (timeline instanceof core.RotateTimeline) this.applyRotateTimeline(timeline, skeleton, animationTime, alpha, timelineBlend, timelinesRotation, i << 1, firstFrame);
            else if (timeline instanceof core.AttachmentTimeline) this.applyAttachmentTimeline(timeline, skeleton, animationTime, timelineBlend, attachments);
            else {
      ...
      AnimationState.prototype.computeHold = function (entry) {
        ...
        outer: for (var i = 0; i < timelinesCount; i++) {
          ...
          else if (to == null || timeline instanceof core.AttachmentTimeline || timeline instanceof core.DrawOrderTimeline || timeline instanceof core.EventTimeline || !to.animation.hasTimeline(id)) {
...
(function (pixi_spine) {
  ...
  var Spine = (function (_super) {
    ...
    function Spine(spineData) {
      ...
      _this.updateTransform = PIXI.Container.prototype.updateTransform;
    ...
    Object.defineProperty(Spine.prototype, 'autoUpdate', {
      ...
      set: function (value) {
        if (value !== this._autoUpdate) {
          ...
          if (value) {
            pixi_spine.core.Ticker.add(Spine.prototype.tickerUpdate, this);
          } else {
            pixi_spine.core.Ticker.remove(Spine.prototype.tickerUpdate, this);
          }
    ...
    Spine.prototype.tickerUpdate = function () {
      const ticker = pixi_spine.core.Ticker;
